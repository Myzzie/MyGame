...
[System.Serializable]
public class DoubleOreChanceManager : MonoBehaviour {
	

	static DoubleOreChanceManager doubleOreChanceManager;
	...
	void Awake()
	{
		...
		doubleOreChanceManager = this;
		doubleOreChanceManager.instance.SetActive(false);
	}
	...
	public static void ShowDoubleOreChance()
	{
		//if instance does not exists return from this function
		
		//enable the loading image object 
		doubleOreChanceManager.instance.SetActive(true);
	}
